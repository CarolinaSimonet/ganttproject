...
public class MyTestComponent {
    ...
    public MyTestComponent(TaskManager taskManager) {
    ...
    public JComponent getComponent() {
        ...
        /*JComponent otherResumeComponent = new JLabel("Outro resumo das tasks");
        panel.add(resumeComponent);
        panel.add(otherResumeComponent);
        ...
        panelLayout.putConstraint(SpringLayout.WEST, otherResumeComponent, 5, SpringLayout.WEST, panel);
        panelLayout.putConstraint(SpringLayout.SOUTH, otherResumeComponent, 50, SpringLayout.NORTH, resumeComponent);*/
        panel.add(resumeComponent);
        panelLayout.putConstraint(SpringLayout.WEST, resumeComponent, 5, SpringLayout.WEST, panel);
        panelLayout.putConstraint(SpringLayout.NORTH, resumeComponent, 5, SpringLayout.NORTH, panel);
      ...
      /*  SpringLayout panelLayout = new SpringLayout();
        ...
        JComponent resumeComponent = new JLabel("Resumo das tasks");
        JComponent otherResumeComponent = new JLabel("Outro resumo das tasks");
        panel.add(resumeComponent);
        panel.add(otherResumeComponent);
